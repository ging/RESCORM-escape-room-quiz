...
/*    if(hasProgressMeasure && hasScore){
    ...
    console.log(score , this.props.config.scorm.score_threshold );
    finishTitleText = this.props.I18n.getTrans(score >= this.props.config.scorm.score_threshold ? "i.clueEarned" : "i.clueLost");
